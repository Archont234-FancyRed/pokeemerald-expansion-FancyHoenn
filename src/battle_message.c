...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_COSMICTERRAINENDS]                    = COMPOUND_STRING("The powers of cosmos disappeared from the battlefield."),
    ...
    [STRINGID_TERRAINBECOMESCOSMIC]                 = COMPOUND_STRING("The powers of cosmos descendet on the battlefield!"),
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_TERRAIN_SET_COSMIC]   = STRINGID_TERRAINBECOMESCOSMIC,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_COSMIC] = STRINGID_COSMICTERRAINENDS,
};
