...
#define ANIM_TAG_COSMIC_DUST                (ANIM_SPRITES_START + 413)
#define ANIM_TAG_COSMIC_BLAST               (ANIM_SPRITES_START + 414)
#define ANIM_TAG_COUNT                      GET_TRUE_SPRITE_INDEX(ANIM_TAG_COSMIC_BLAST + 1)
